    ...
    switch (sortByDiff) {
      case 'difficulty':
        sortedArray.sort((a, b) => {
          // Define an order for the difficulty levels
          ...
          // Compare the difficulty levels using the defined order
          return isAscending
        ...
        break;
      default:
        sortedArray = [...problems];
        break;
    }

    switch (sortBySolv) {
      case 'solved':
        sortedArray.sort((a, b) => (isAscending ? a.solved - b.solved : b.solved - a.solved));
        break;
      default:
        sortedArray = [...problems];
        break;
